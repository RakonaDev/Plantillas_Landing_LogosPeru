        ...
        index % 2 === 0 ? (
          <>
            ...
            <div className="w-full lg:w-1/2 space-y-6 text-white">
              <h3 className="font-ConstellationTLPro-Bold text-xl md:text-2xl lg:text-3xl text-secondary">{servicio.titulo}</h3>
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-10 items-center">
            <div className="w-full lg:w-1/2 space-y-6 text-white flex flex-col items-end ">
              <h3 className="font-ConstellationTLPro-Bold text-xl md:text-2xl lg:text-3xl text-secondary text-end">{servicio.titulo}</h3>
            ...
            <div className="w-full lg:w-1/2">
              <img src={servicio.imagen} alt="servicio" className="w-full h-full object-cover" />
            </div>
          </div>
        )
      }
